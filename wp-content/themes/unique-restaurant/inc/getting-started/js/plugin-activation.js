jQuery(document).ready(function($) {
    'use strict';
    var this_obj = unique_restaurant_plugin_activate_plugin;

    $('#Mizan_Demo_Importor_editor .plugin-activation-redirect a').addClass('mdi-redirect-to-dashboard');

    $(document).on('click', '.unique-restaurant-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message unique-restaurant-plugin-install');
                button.addClass('button-primary unique-restaurant-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.unique-restaurant-recommended-plugins .unique-restaurant-activation-note').css('display','block');
    ...
    $(document).on('click', '.unique-restaurant-plugin-activate', function(event) {
