 ...
 * @since 1.0.0
 */
class Unique_Restaurant_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'unique_restaurant';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'unique-restaurant' ), $i ),
...
// Initialize.
$Unique_Restaurant_Footer_Widgets = new Unique_Restaurant_Footer_Widgets();