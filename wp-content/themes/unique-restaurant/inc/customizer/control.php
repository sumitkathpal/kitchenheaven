 ...
 */
class Unique_Restaurant_Dropdown_Taxonomies_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		$choices = array();
		$choices[0] = esc_html__( '&mdash; Select &mdash;', 'unique-restaurant' );
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'unique-restaurant-customize-controls' );
		wp_enqueue_script( 'unique-restaurant-customize-controls' );
 ...
 * @see WP_Customize_Control
 */
class Unique_Restaurant_Section_Manager_Control extends WP_Customize_Control {
	/**
	 * Control type.
	 *
	 * @access public
