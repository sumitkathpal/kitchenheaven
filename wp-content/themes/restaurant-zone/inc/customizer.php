...
if ( ! defined( 'RESTAURANT_ZONE_URL' ) ) {
    define( 'RESTAURANT_ZONE_URL', esc_url( 'https://www.themagnifico.net/products/restaurant-wordpress-theme', 'restaurant-zone') );
}
if ( ! defined( 'RESTAURANT_ZONE_TEXT' ) ) {
    define( 'RESTAURANT_ZONE_TEXT', __( 'Restaurant Zone Pro','restaurant-zone' ));
}
if ( ! defined( 'RESTAURANT_ZONE_BUY_TEXT' ) ) {
    define( 'RESTAURANT_ZONE_BUY_TEXT', __( 'Buy Restaurant Zone Pro','restaurant-zone' ));
}
...
function restaurant_zone_customize_register($wp_customize){
    ...
    class Restaurant_Zone_Customize_Pro_Version extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            echo '<a href="'. esc_url($this->description) .'" target="_blank">';
                ...
                echo '<strong> '. esc_html( RESTAURANT_ZONE_BUY_TEXT,'restaurant-zone' ) .'<strong></a>';
            echo '</a>';
        }
    }
  ...
  $wp_customize->add_setting('restaurant_zone_logo_title_text', array(
    ...
    $wp_customize->add_setting('restaurant_zone_logo_title_color', array(
        'default'           => '',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'restaurant_zone_logo_title_color', array(
        'label'    => __('Site Title Color', 'restaurant-zone'),
        'section'  => 'title_tagline'
    )));

    $wp_customize->add_setting('restaurant_zone_logo_tagline_color', array(
        'default'           => '',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'restaurant_zone_logo_tagline_color', array(
        'label'    => __('Site Tagline Color', 'restaurant-zone'),
        'section'  => 'title_tagline'
    )));
    ...
    $wp_customize->add_control( new Restaurant_Zone_Customize_Pro_Version ( $wp_customize,'pro_version_logo', array(
        'section'     => 'title_tagline',
        'type'        => 'pro_options',
    ...
    $wp_customize->add_control('restaurant_zone_scroll_top_position',array(
        'label' => __('Scroll To Top Positions','restaurant-zone'),
        'type' => 'radio',
        'section' => 'restaurant_zone_general_settings',
        'choices' => array(
    ...
    $wp_customize->add_setting( 'restaurant_zone_scroll_to_top_border_radius', array(
        'default'              => '',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'restaurant_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'restaurant_zone_scroll_to_top_border_radius', array(
        'label'       => esc_html__( 'Scroll To Top Border Radius','restaurant-zone' ),
        'section'     => 'restaurant_zone_general_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting( 'restaurant_zone_woo_product_image_box_shadow', array(
        'default'              => '0',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'restaurant_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'restaurant_zone_woo_product_image_box_shadow', array(
        'label'       => esc_html__( 'Product Image Box Shadow','restaurant-zone' ),
        'section'     => 'restaurant_zone_general_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting('restaurant_zone_woocommerce_product_sale',array(
        'default' => 'Left',
        'sanitize_callback' => 'restaurant_zone_sanitize_choices'
    ));
    $wp_customize->add_control('restaurant_zone_woocommerce_product_sale',array(
        'label' => __('Woocommerce Product Sale Positions','restaurant-zone'),
        'type' => 'radio',
        'section' => 'restaurant_zone_general_settings',
        'choices' => array(
            'Right' => __('Right','restaurant-zone'),
    ...
    $wp_customize->add_setting( 'restaurant_zone_woo_product_sale_border_radius', array(
        'default'              => '',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'restaurant_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'restaurant_zone_woo_product_sale_border_radius', array(
        'label'       => esc_html__( 'Woocommerce Product Sale Border Radius','restaurant-zone' ),
        'section'     => 'restaurant_zone_general_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    // Related Product
    $wp_customize->add_setting('restaurant_zone_woocommerce_related_product_show_hide', array(
        'default' => true,
        'sanitize_callback' => 'restaurant_zone_sanitize_checkbox'
    ));
    $wp_customize->add_control( new WP_Customize_Control($wp_customize,'restaurant_zone_woocommerce_related_product_show_hide',array(
        'label'          => __( 'Show / Hide Related product', 'restaurant-zone' ),
        'section'        => 'restaurant_zone_general_settings',
        'settings'       => 'restaurant_zone_woocommerce_related_product_show_hide',
        'type'           => 'checkbox',
    )));
    ...
    $wp_customize->add_setting( 'restaurant_zone_post_page_image_border_radius', array(
        'default'              => '0',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'restaurant_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'restaurant_zone_post_page_image_border_radius', array(
        'label'       => esc_html__( 'Post Page Image Border Radius','restaurant-zone' ),
        'section'     => 'restaurant_zone_post_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting( 'restaurant_zone_post_page_image_box_shadow', array(
        'default'              => '0',
        'transport'            => 'refresh',
        'sanitize_callback'    => 'restaurant_zone_sanitize_number_range'
    ) );
    $wp_customize->add_control( 'restaurant_zone_post_page_image_box_shadow', array(
        'label'       => esc_html__( 'Post Page Image Box Shadow','restaurant-zone' ),
        'section'     => 'restaurant_zone_post_settings',
        'type'        => 'range',
        'input_attrs' => array(
            'step'             => 1,
    ...
    $wp_customize->add_setting('restaurant_zone_post_page_cat',array(
        'sanitize_callback' => 'restaurant_zone_sanitize_checkbox',
        'default'           => 1,
    ));
    $wp_customize->add_control('restaurant_zone_post_page_cat',array(
        'type'        => 'checkbox',
        'label'       => esc_html__('Enable Post Page Category and Tags', 'restaurant-zone'),
        'section'     => 'restaurant_zone_post_settings',
        'description' => esc_html__('Check this box to enable category and tags on post page.', 'restaurant-zone'),
    ));
    ...
    $wp_customize->add_setting('restaurant_zone_single_post_cat',array(
        'sanitize_callback' => 'restaurant_zone_sanitize_checkbox',
        'default'           => 1,
    ));
    $wp_customize->add_control('restaurant_zone_single_post_cat',array(
        'type'        => 'checkbox',
        'label'       => esc_html__('Enable Single Post Category and Tags', 'restaurant-zone'),
        'section'     => 'restaurant_zone_post_settings',
        'description' => esc_html__('Check this box to enable post category and tags on single post.', 'restaurant-zone'),
    ));

    $wp_customize->add_setting('restaurant_zone_single_post_navigation_show_hide',array(
        'default' => true,
        'sanitize_callback' => 'restaurant_zone_sanitize_checkbox'
    ));
    $wp_customize->add_control('restaurant_zone_single_post_navigation_show_hide',array(
        'type' => 'checkbox',
        'label' => __('Show / Hide Post Navigation','restaurant-zone'),
        'section' => 'restaurant_zone_post_settings',
    ));

    $wp_customize->add_setting('restaurant_zone_single_post_comment_title',array(
        'default'=> 'Leave a Reply',
        'sanitize_callback' => 'sanitize_text_field'
    ));

    $wp_customize->add_control('restaurant_zone_single_post_comment_title',array(
        'label' => __('Add Comment Title','restaurant-zone'),
        'input_attrs' => array(
        'placeholder' => __( 'Leave a Reply', 'restaurant-zone' ),
        ),
        'section'=> 'restaurant_zone_post_settings',
        'type'=> 'text'
    ));

    $wp_customize->add_setting('restaurant_zone_single_post_comment_btn_text',array(
        'default'=> 'Post Comment',
        'sanitize_callback' => 'sanitize_text_field'
    ));

    $wp_customize->add_control('restaurant_zone_single_post_comment_btn_text',array(
        'label' => __('Add Comment Button Text','restaurant-zone'),
        'input_attrs' => array(
            'placeholder' => __( 'Post Comment', 'restaurant-zone' ),
        ),
        'section'=> 'restaurant_zone_post_settings',
        'type'=> 'text'
    ));
    ...
    $wp_customize->add_control( new Restaurant_Zone_Customize_Pro_Version ( $wp_customize,'pro_version_post_setting', array(
        'section'     => 'restaurant_zone_post_settings',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Customizer Options', 'restaurant-zone' ),
        'description' => esc_url( RESTAURANT_ZONE_URL ),
    ...
    $wp_customize->add_control( new Restaurant_Zone_Customize_Pro_Version ( $wp_customize,'pro_version_single_page_setting', array(
        'section'     => 'restaurant_zone_page_settings',
        'type'        => 'pro_options',
        'label'       => esc_html__( 'Customizer Options', 'restaurant-zone' ),
        'description' => esc_url( RESTAURANT_ZONE_URL ),
    ...
    //Slider height
    $wp_customize->add_setting('restaurant_zone_slider_img_height',array(
        'default'=> '',
        'sanitize_callback' => 'sanitize_text_field'
    ));
    $wp_customize->add_control('restaurant_zone_slider_img_height',array(
        'label' => __('Slider Height','restaurant-zone'),
        'description'   => __('Add the slider height in px(eg. 500px).','restaurant-zone'),
        'input_attrs' => array(
            'placeholder' => __( '500px', 'restaurant-zone' ),
        ),
        'section'=> 'restaurant_zone_top_slider',
        'type'=> 'text'
    ));
    ...
    $wp_customize->add_setting('restaurant_zone_show_hide_footer',array(
        'default' => true,
        'sanitize_callback' => 'restaurant_zone_sanitize_checkbox'
    ));
    $wp_customize->add_control('restaurant_zone_show_hide_footer',array(
        'type' => 'checkbox',
        'label' => __('Show / Hide Footer','restaurant-zone'),
        'section' => 'restaurant_zone_site_footer_section',
        'priority' => 1,
    ));

    $wp_customize->add_setting('restaurant_zone_footer_background_color', array(
        'default'           => '',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'restaurant_zone_footer_background_color', array(
        'label'    => __('Footer Background Color', 'restaurant-zone'),
        'section'  => 'restaurant_zone_site_footer_section',
    )));

    $wp_customize->add_setting('restaurant_zone_footer_bg_image',array(
        'default'   => '',
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control( new WP_Customize_Image_Control($wp_customize,'restaurant_zone_footer_bg_image',array(
        'label' => __('Footer Background Image','restaurant-zone'),
        'section' => 'restaurant_zone_site_footer_section',
    )));
    ...
    $wp_customize->add_control('restaurant_zone_footer_text_setting', array(
        'label' => __('Replace the copyright text', 'restaurant-zone'),
        'section' => 'restaurant_zone_site_footer_section',
        'type' => 'text',
    ));

    $wp_customize->add_setting('restaurant_zone_copyright_background_color', array(
        'default'           => '',
        'sanitize_callback' => 'sanitize_hex_color',
    ));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'restaurant_zone_copyright_background_color', array(
        'label'    => __('Copyright Background Color', 'restaurant-zone'),
        'section'  => 'restaurant_zone_site_footer_section',
    )));
