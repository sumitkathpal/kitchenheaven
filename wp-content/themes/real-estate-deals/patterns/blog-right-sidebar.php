 ...
 * Slug: real-estate-deals/blog-right-sidebar
 * Categories: real-estate-deals, blog-right-sidebar
 */
?>
...
<div class="wp-block-column sidebar-col" style="flex-basis:30%"><!-- wp:template-part {"slug":"sidebar","theme":"real-estate-deals","area":"uncategorized"} /--></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></main>
<!-- /wp:group -->