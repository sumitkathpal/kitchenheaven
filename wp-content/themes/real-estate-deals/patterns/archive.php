...
/**
 * Title: Archives
 * Slug: real-estate-deals/archive
 * Categories: real-estate-deals, archive
 */
?>

<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() . '/images/inner-banner.jpg'); ?>","id":19,"dimRatio":50,"minHeight":300,"isDark":false,"className":"inner-cover-img","layout":{"type":"constrained","contentSize":"90%"}} -->
...
<h3 class="wp-block-heading has-text-align-center"><?php esc_html_e('Sorry, no post exist...','real-estate-deals'); ?></h3>
<!-- /wp:heading -->
